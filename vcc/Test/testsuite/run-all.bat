...
..\..\Host\bin\debug\vcc.exe /smoke /s /time /smt:0.7 done examples tutorial vacid-0 vcc2 vcc2ns vscomp2010 ..\..\Demo ..\..\Docs\SyntaxUpdate\FromTutorial ..\..\Docs\Tutorial\c
...
..\..\Host\bin\debug\vcc.exe /smoke /s /time /smt:0.7 /3 vcc3
