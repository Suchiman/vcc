...
axiom $type_branch(^^i1) == $ctype_flat;

axiom $type_branch(^^i2) == $ctype_flat;
axiom $type_branch(^^i4) == $ctype_flat;
axiom $type_branch(^^i8) == $ctype_flat;
axiom $type_branch(^^u1) == $ctype_flat;
axiom $type_branch(^^u2) == $ctype_flat;
axiom $type_branch(^^u4) == $ctype_flat;
axiom $type_branch(^^u8) == $ctype_flat;
axiom $type_branch(^^f4) == $ctype_flat;
axiom $type_branch(^^f8) == $ctype_flat;

axiom $type_branch(^^mathint) == $ctype_flat;
axiom $type_branch(^^bool) == $ctype_flat;
axiom $type_branch(^^void) == $ctype_flat;
axiom $type_branch(^^claim) == $ctype_flat;
axiom $type_branch(^^root_emb) == $ctype_flat;
axiom $type_branch(^$#ptrset) == $ctype_flat;
axiom $type_branch(^$#thread_id_t) == $ctype_flat;
axiom $type_branch(^$#state_t) == $ctype_flat;
axiom $type_branch(^$#struct) == $ctype_flat;
...
axiom (forall #n:$ctype :: {$ptr_to(#n)} $unptr_to($ptr_to(#n)) == #n && $type_branch($ptr_to(#n)) == $ctype_ptr);
axiom (forall #n:$ctype :: {$spec_ptr_to(#n)} $unptr_to($spec_ptr_to(#n)) == #n && $type_branch($spec_ptr_to(#n)) == $ctype_spec_ptr);
