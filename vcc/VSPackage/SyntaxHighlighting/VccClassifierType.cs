namespace Microsoft.Research.Vcc.VSPackage
{
    ...
    internal static class VccClassificationTypeDefinitions
    {
        ...
        [Export]
        [Name(SpecType)]
        [BaseDefinition(VisualStudio.Language.StandardClassification.PredefinedClassificationTypeNames.FormalLanguage)]
        // ReSharper disable RedundantDefaultFieldInitializer
        ...
        [Export]
        [Name(KeywordType)]
        [BaseDefinition(VisualStudio.Language.StandardClassification.PredefinedClassificationTypeNames.Keyword)]
        // ReSharper disable RedundantDefaultFieldInitializer
