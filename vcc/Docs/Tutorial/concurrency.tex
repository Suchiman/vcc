...
single (typically fixed) object; when you acquire an exclusive 
lock, you obtain ownership of the object protected by the lock. You
are then free to operate on tht object just as you would in sequential
programming; you can unwrap it, play with it, and eventually wrap it
up and release the lock, giving ownership of the protected object back
to the lock. 
