...
typedef struct ArraySet {
  ...
  int data[SIZE];            // a list of elements of the set
  unsigned len;              // the number of array elements used
  _(ghost unsigned idx[int]) // where in the list to find each element
