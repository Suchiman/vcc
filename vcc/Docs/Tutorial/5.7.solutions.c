...
// a function that checks whether two sorted arrays contain a common element;
...
//a function that takes an array and checks whether it contains any duplicate elements;
