...
and in addition we know \vcc{E != 0}.
\item
...
\begin{enumerate}
\item
Specify and verify an iterative program that copies an array from one
location to another.
\item
Specify and verify an iterative program for binary search (a program
that checks whether a sorted array contains a given value).
\item
Verify an iterative program that sorts an array of ints using
