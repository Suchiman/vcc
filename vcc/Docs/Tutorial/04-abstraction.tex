...
\begin{note}
What follows, till the beginning of \secref{concurrency} (which is about concurrency), is likely the most difficult part of this tutorial.
...
These topics are not required to understand \secref{concurrency}.
\end{note}
