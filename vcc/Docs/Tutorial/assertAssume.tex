...
\todo{It doesn't exactly eliminate the reasoning about pointers, does it?}
...
\todo{Should the rest of this paragraph be in a footnote?}
...
% Also, this note is something we probably want people to read. -E
% This not necessary for the main text flow. --MM
...
% moved thus up from the assumptions section -E
