...
\Def{Wrapped} objects are ones for which invariant holds,
...
and at the assert\slash assume desugaring of \vcc{sstr_append_char()} function.
...
_(unwrap o) { ... } _(wrap o)
\end{VCC}
\itodo{should we use ``s'' instead of ``the string'', and similarly for content?}
