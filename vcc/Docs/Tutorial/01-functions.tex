...
precondition of the object being \vcc{\unwrapped} (also described in
...
\Def{writable}. Writability requires the object to be \vcc{\unwrapped}
...
More precisely, an object is \vcc{\writable} if it is \vcc{\unwrapped} and 
it is either listed in a writes clause of the function,
or it became \vcc{\unwrapped} sometime after the function was entered; the 
