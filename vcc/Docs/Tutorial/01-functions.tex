...
\footnote{It's not quite the same when considering objects that are
  wrapped; see section \secref{sect:invariants}.}.  VCC allows you
...
wrapped (section \secref{sect:invariants}) or reinterpreted to a
different type (section \secref{sect:reinterpretation}).  VCC asserts
...
unwrapping of other objects (section \secref{sect:invariants}). 
