...
the function.%
\footnote{This gets a bit more complicated when objects
change ownership. 
\itodo{maybe it shouldn't get more complicated? --MM}
When in doubt always use explicit writes clauses on loops.}
