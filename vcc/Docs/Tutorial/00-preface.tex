...
verify interesting programs. \todo{this might be too much}
...
\itodo{We don't want to have this installation thing here, it should
just point to the website, which should have instructions.}
...
\todo{This is silly. Shouldn't we just install vcc.h into the VC
include directory or something?}
\begin{enumerate}
...
\itodo{Make sure about environment variables and paths.}
